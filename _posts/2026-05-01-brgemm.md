...
In [Part 1](/_posts/2026-04-05-intel-amx.md), we walked through the evolution of matrix multiplication on CPUs — from a naive triple loop (730ms) through loop reordering (130ms) and tiling (89ms), all the way to AMX's 2D tile registers that can deliver 1024 BF16 ops/cycle.
